...
final case class BackPressureRemoveEvent(backPressure:BackPressure) extends ContestCommand
final case class BackPressureUpdateEvent(backPressure:BackPressure) extends ContestCommand